...
function sh_post_types_custom_box() {
    ...
    foreach ($sh_post_types as $post_type) {
        add_meta_box( 'hide_featured', __( 'Show or Hide Featured Image', 'HideImage' ), 'sh_featured_box', $post_type, 'side', 'default' );
    }
                    ...
                    <div id="post-body-content">
                         <form method="post" action="options.php">
                              ...
                              <table class="form-table">
                                   <tr valign="top"><th scope="row"><?php _e( 'Hide from all Posts(not Custom Post Type)?', 'HideImage' ); ?></th>
                                        <td>
                                    ...
                                    <tr valign="top"><th scope="row"><?php _e( 'Hide from all Pages?', 'HideImage' ); ?></th>
                                        <td>
