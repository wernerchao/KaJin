<?php
    ...
    $reply=mysql_query("select c.* ,u.name as user_name, c1.name_ch as coun_name from comment c left join user u on c.u_id=u.Id, counselor c1 where c.c_Id=". $_GET["counselor"] ." and c1.Id=c.c_Id order by c.q_id desc");
?>
<!DOCTYPE html>
<html lang="zh-tw">
<head>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="info-block2" id="qa-big-block" style="overflow-y:scroll;max-height:1000px;background:#FAFAFA;">
                            ...
                            <?php
                                $qid=0;
                                $rep = mysql_fetch_array($reply, MYSQL_ASSOC);
                                while ($rep){
                                $qid = $rep["q_Id"];
                            ?>
                            <div class="qa">
                                <div class="small-qa">
                                    ...
                                    <?php
                                    while ($rep = mysql_fetch_array($reply, MYSQL_ASSOC)){
                                        if($rep["q_Id"]!=$qid)
                                            break;
                                ?>
                                <div class="small-qa reply">
                                    ...
                                    ?>
                                        ...
                                        <div class="info">
                                            <h5 class="name"><?php echo $rep["coun_name"];?></h5>
                                            <p class="content"><?php echo $rep["text"]?></p>
                                        </div>
                                    <?php
                                        }
