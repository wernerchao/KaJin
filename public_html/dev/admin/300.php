...
if($_GET['showall']) $sql = $mysql->query("Select * From `appointment` Order By `date` Desc, `time` Desc");
else $sql = $mysql->query("Select * From `appointment` Where `user_id` != '0' Order By `date` Desc, `time` Desc");
