...
foreach($list_counselor as $k => $v) echo "<a href=\"350.php?id=".$k."\">".$v['name_ch']."</a> ";
echo "<br><br>";
...
for($w=1; $w<=6; $w++)
{
	...
	for($i=0; $i<=6; $i++)
	{
		...
		for($j=0; $j<=23; $j++)
		{
			...
			{
				if($appointment_data[$date][$j]['user_id']) echo "<td bgcolor=\"#ffaaaa\"><a href=\"301.php?id=".$appointment_data[$date][$j]['id']."\"><font color=\"black\">預</font></a></td>";
				else echo "<td bgcolor=\"#aaaaff\"></td>";
			}
			else echo "<td></td>";
		}
		echo "</tr>";
