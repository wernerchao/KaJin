...
(function(window){
    ...
    $(document).ready(function(){
        ...
        //----------test----------
        $.ajax({
            url:'https://kajinonline.com/dev/ajax_api_get_options.php',//real
            type:'GET', 
            dataType:'json',
        ...
        $.ajax({
            url:'https://kajinonline.com/dev/ajax_api_get_counselor_info.php',//real
            type:'GET', 
            dataType:'json',
            success:function(data){
                teacherinfo=data;
        ...
        $('#step3 #book-confirm .next-step').on('click',function(){
            ...
            var handler = StripeCheckout.configure({
                ...
                token: function(res){
                    $.ajax({
                        url:'https://kajinonline.com/dev/ajax_api_start_pay.php',//real
                        type:'POST', 
                        data:{
        ...
        $('#step-need-help #colelem2 .next-step').on('click',function(){
            ...
            $.ajax({
                url:'https://kajinonline.com/dev/ajax_api_need_help.php',//real
                type:'POST', 
                data:{
    ...
    function setTeacherSchedule(){
        $.ajax({
            url:'https://kajinonline.com/dev/ajax_api_start_get_available.php',
            type:'POST',
            data:{
                counselor_id:getTeacherId(),
    ...
    function toFinal(){ //by answer question
        ...
        //-------選擇老師ajax-------
        $.ajax({
            url:'https://kajinonline.com/dev/ajax_api_start_get_counselor.php',
            type:'POST',
            data:{
                answer0:answer0,
                answer1:answer1,
