...
$f = fopen('pay_e.txt', 'a');fputs($f, $_SERVER['REMOTE_ADDR'].' ');fputs($f, '0 ');
// 輸入
...
// 修改為已付款
$mysql->query("Update `appointment` Set `state_counsel` = '1', `state_payment` = '3', `fee` = '$fee_count_twd' Where `id` = '$data_appointment[id]'");
// 新增 zoom id
